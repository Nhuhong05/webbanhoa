...
namespace webhoa.Controllers
{
    ...
    public class TaikhoanController : ControllerBase
    {
        ...
        public TaikhoanController(SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager)
        {
        ...
        public async Task<IActionResult> Register([FromBody] UserDetails userDetails)
        {
            ...
            {
                return new BadRequestObjectResult(new { Message = " Lỗi đăng ký" });
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return Ok(new { Massage = " User đã thoát" });
